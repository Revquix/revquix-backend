...
public class UserAuthServiceImpl implements UserAuthService {
    ...
    @Override
    public ResponseEntity<ModuleResponse> enableMfa() {
        ...
        if (userAuth.isMfaEnabled())
            throw new BadRequestException(ErrorData.MFA_ALREADY_ENABLED);
        userAuth.setMfaEnabled(true);
        UserAuth userAuthResponse = userAuthRepository.save(userAuth);
        log.info("{}::enableMfa -> MFA enabled successfully for userId: {}", getClass().getSimpleName(), userId);
